...
\definecolor{contrast}{rgb}{0.0,0.45,0.75}
...
\ifBgUse%
\ifodd\value{page}
\backgroundsetup{position={current page.north east},vshift=3.5cm,%
contents={\VerBar{black}{2\paperheight}}}%
\else
\backgroundsetup{position={current page.north west},vshift=-3.5cm,%
contents={\VerBar{black}{2\paperheight}}}%
\fi%
\BgMaterial%
\fi}
...
\begin{document}
	...
	\newgeometry{inner = 1.5cm, outer = 4cm, marginparwidth = 3cm, marginparsep = 0.5cm}
